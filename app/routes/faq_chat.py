...
async def faq_chat(request: ChatRequest):
    ...
    system_prompt = (
        ...
        "the following facts:\n\n"
        "- The system detects deepfakes/manipulated videos using EfficientNet-B0, a CPU-optimized "
        ...
        "- Users must register (with email verification) or sign in with Google to use the platform.\n"
        "- All analyses are saved to the user's dashboard for later review.\n"
        "- The platform is free, open-source, and designed to run without expensive GPU hardware.\n"
